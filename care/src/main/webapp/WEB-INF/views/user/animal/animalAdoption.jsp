...
<body id="body" style="display: none;">
    ...
    <div class="page-wrapper">
        <div class="adoption-wrapper">
            ...
            <form id="adoptionForm" class="adoption-form" method="post" onsubmit="submitAdoption(); return false;">
                <div>
                    <label>이름</label>
                ...
                <div>
                    ...
                    <div style="display: flex; gap: 8px;">
                        <input type="text" name="zipCode" id="zipCode" required readonly>
                        <input type="button" value="주소 찾기" onclick="execDaumPostcode()" class="address-search-button">
                    </div>
                </div>
